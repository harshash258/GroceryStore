...
public class BeautyandBeast extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = databaseReference.orderByChild("category").equalTo("Beauty and Grooming");
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new ProductAdapter(BeautyandBeast.this, productsList);
    ...
    private void searchProducts(String productName) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new ProductAdapter(BeautyandBeast.this, searchList);
                recyclerView.setAdapter(adapter);
            }
