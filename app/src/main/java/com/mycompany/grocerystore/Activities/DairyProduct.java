...
public class DairyProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = databaseReference.orderByChild("category").equalTo("Dairy Products");
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new ProductAdapter(DairyProduct.this, productsList);
    ...
    private void searchProducts(String productName) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new ProductAdapter(DairyProduct.this, searchList);
                recyclerView.setAdapter(adapter);
            }
