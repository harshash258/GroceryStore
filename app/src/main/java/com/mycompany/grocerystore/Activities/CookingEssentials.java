...
public class CookingEssentials extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cooking_essentials);
        ...
        Query query = databaseReference.orderByChild("category").equalTo("Cooking Essentials");
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new ProductAdapter(CookingEssentials.this, productsList);
    ...
    private void searchProducts(String productName) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new ProductAdapter(CookingEssentials.this, searchList);
                recyclerView.setAdapter(adapter);
            }
