...
public class HousingNeeds extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_housing_needs);
        ...
        Query query = databaseReference.orderByChild("category").equalTo("Housing Need");
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new ProductAdapter(HousingNeeds.this, productsList);
    ...
    private void searchProducts(String productName) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new ProductAdapter(HousingNeeds.this, searchList);
                recyclerView.setAdapter(adapter);
            }
