...
public class PackagedFood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = databaseReference.orderByChild("category").equalTo("Packaged Food");
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new ProductAdapter(PackagedFood.this, productsList);
    ...
    private void searchProducts(String productName) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new ProductAdapter(PackagedFood.this, searchList);
                recyclerView.setAdapter(adapter);
            }
